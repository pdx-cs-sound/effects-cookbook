...
## Embedded into chapters

Three AudioExplorers were tried here and now live on the pages they belong to:
[Tremolo](tremolo.md), [Waveforms & oscillators](waveforms.md), and
[Vibrato](vibrato.md). Each runs an AudioWorklet port of the chapter's own Python, and
a golden test compares the port against that Python sample by sample.
