...
10. **[Filter effects](filter-effects.md)** — equalization, wah, and phasing.
11. **[DFT, FFT, STFT](transforms.md)** — the transforms, windows, the spectrogram.
12. **[Frequency-domain effects](frequency-effects.md)** — resampling, spectral
